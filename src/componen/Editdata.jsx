      ...
      <div className={`flex-1 p-8 ml-56 ${baseAnimation}`}>
        <div className={`bg-white p-6 ml-65 m-15 rounded-lg shadow-xl max-w-lg transition-all ease-out duration-700 delay-100 ${baseAnimation}`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input name="nama" value={form.nama} onChange={handleChange} placeholder="Nama" className="w-full border px-4 py-2 rounded focus:ring-emerald-500 focus:border-emerald-500 transition duration-150" required />
