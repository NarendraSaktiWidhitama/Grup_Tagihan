...
const Sidnav = () => {
  ...
  return (
    <div className="fixed top-0 left-0 h-full w-56 shadow-2xl text-white bg-gradient-to-br from-emerald-500 to-emerald-700 flex flex-col transition-all duration-300">
      ...
      <nav className="mt-4 space-y-3 px-3 flex-1">
        <Link 
          to="/dashboard" 
